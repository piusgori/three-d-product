...
const FilePicker = ({ file, setFile, readFile }: { file: any, setFile: any, readFile: any }) => {
  ...
  return (
    <div className="filepicker-container">
        <div className="flex-1 flex flex-col">
            ...
            <p className="mt-2 text-gray-50 text-xs truncate">{file === '' ? 'No file selected' : file.name}</p>
        </div>
